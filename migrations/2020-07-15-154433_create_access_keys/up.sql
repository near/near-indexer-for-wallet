CREATE TYPE execution_status_type AS ENUM ('PENDING', 'FAILED', 'SUCCESS');
CREATE TYPE access_key_action_type AS ENUM ('ADD', 'DELETE');
CREATE TYPE access_key_permission_type AS ENUM ('NOT_APPLICABLE', 'FULL_ACCESS', 'FUNCTION_CALL');

CREATE TABLE access_keys (
    public_key text NOT NULL,
    account_id text NOT NULL,
    "action" access_key_action_type NOT NULL,
    status execution_status_type NOT NULL,
